...
public class WriterView {
    ...
    public void handle() {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "7" -> delete();
                case "8", "exit", "Exit" -> running = false;
    ...
    private void create() {
        ...
        WriterDTO savedWriter = writerController.createWithPosts(firstName, secondName);
    ...
    private void update() {
        ...
        WriterDTO updated = writerController.update(id, firstName, secondName);
        if (updated != null) {
