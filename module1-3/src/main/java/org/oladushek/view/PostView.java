...
public class PostView {
    ...
    public void handle() {
        ...
        while (running) {
            ...
            System.out.println("3. Read All posts by Title");
    ...
    private void readAllByTitle() {
        System.out.print("Enter post title: ");
        String title = scanner.nextLine();
        List<PostDTO> posts = postController.getAllByTitle(title);
        if (posts.isEmpty()) {
            System.out.println("No posts found.");
        } else {
            System.out.print("All active posts: \n");
    ...
    private void update() {
        ...
        System.out.print("Enter new title (\"exit\" for skip): ");
        String newTitle = scanner.nextLine();

        System.out.print("Enter new content (\"exit\" for skip): ");
        String newContent = scanner.nextLine();

        PostDTO updated = postController.update(id, newTitle, newContent, labelsIdForNewPost());
        if (updated != null) {
